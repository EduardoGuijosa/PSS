...
/*
Este archivo db.js se encarga de establecer la conexión a la base de datos MySQL utilizando la biblioteca mysql2. 
Se configura la conexión con los parámetros necesarios (host, user, password, database) y se maneja cualquier error que pueda ocurrir durante la conexión. 
Finalmente, se exporta la conexión para que pueda ser utilizada en otros archivos del proyecto.
*/